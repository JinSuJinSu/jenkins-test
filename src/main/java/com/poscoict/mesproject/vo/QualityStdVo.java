...
public class QualityStdVo {
	...
	public String toString() {
		return "QualityStdVo [factory=" + factory + ", widthMin=" + widthMin + ", widthMax=" + widthMax
				+ ", thicknessMin=" + thicknessMin + ", thicknessMax=" + thicknessMax + ", lengthMin=" + lengthMin
				+ ", lengthMax=" + lengthMax + ", weightMin=" + weightMin + ", weightMax=" + weightMax + ", confirm="
				+ confirm + "]";
	}
